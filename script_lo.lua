...
v5.Window = function(v134, v135)
	...
	v147.BackgroundColor3 = Color3.fromRGB(15, 15, 20);
	v147.BackgroundTransparency = 1;
	v147.Position = UDim2.new(0.5, 0, 0.5, 0);
	v147.Size = UDim2.new(0, 0, 0, 0);
	
	-- Gradient Background
	local v147Gradient = Instance.new("UIGradient");
	v147Gradient.Parent = v147;
	v147Gradient.Color = ColorSequence.new{
		ColorSequenceKeypoint.new(0, Color3.fromRGB(15, 15, 25)),
		ColorSequenceKeypoint.new(1, Color3.fromRGB(10, 15, 30))
	};
	v147Gradient.Rotation = 45;
	
	-- Shadow/Glow Effect
	local v147Shadow = Instance.new("ImageLabel");
	v147Shadow.Name = "Shadow";
	v147Shadow.Parent = v147;
	v147Shadow.BackgroundTransparency = 1;
	v147Shadow.Size = UDim2.new(1, 20, 1, 20);
	v147Shadow.Position = UDim2.new(0, -10, 0, -10);
	v147Shadow.ZIndex = 0;
	v147Shadow.Image = "rbxassetid://1316045217";
	v147Shadow.ImageColor3 = Color3.fromRGB(0, 134, 139);
	v147Shadow.ImageTransparency = 0.8;
	v147Shadow.ScaleType = Enum.ScaleType.Slice;
	v147Shadow.SliceCenter = Rect.new(10, 10, 118, 118);
	
	-- Smooth opening animation
	v147:TweenSize(UDim2.new(0, 555, 0, 352), "Out", "Back", 0.6, true);
	v3:Create(v147, TweenInfo.new(0.6, Enum.EasingStyle.Back, Enum.EasingDirection.Out), {
	...
	v156.Color = Color3.fromRGB(0, 255, 255);
	...
	spawn(function()
		while wait(2) do
			v3:Create(v156, TweenInfo.new(1, Enum.EasingStyle.Sine, Enum.EasingDirection.InOut), {
				Transparency = 0.3,
				Thickness = 3
			}):Play();
			wait(1);
	...
	v197.Text = "NND";
	v197.TextSize = 17;
	v197.TextColor3 = Color3.fromRGB(0, 255, 255);
	v197.TextXAlignment = Enum.TextXAlignment.Left;
	v197.TextStrokeTransparency = 0.8;
	v197.TextStrokeColor3 = Color3.fromRGB(0, 134, 139);
	
	-- Title glow animation
	spawn(function()
		while wait(2) do
			v3:Create(v197, TweenInfo.new(1, Enum.EasingStyle.Sine, Enum.EasingDirection.InOut), {
	...
	v264.Padding = UDim.new(0, 10);
		v264.TweenTime = 0.3;
		v264.EasingStyle = Enum.EasingStyle.Quart;
	...
	v2.InputBegan:Connect(function(v637)
		if (v637.KeyCode == Enum.KeyCode.RightControl) then
			if (v137 == false) then
				v137 = true;
				-- Smooth close animation with scale and fade
				v3:Create(v147, TweenInfo.new(0.4, Enum.EasingStyle.Back, Enum.EasingDirection.In), {
					BackgroundTransparency = 1
				}):Play();
				v147:TweenSize(UDim2.new(0, 0, 0, 0), "In", "Back", 0.4, true);
			else
				v137 = false;
				-- Smooth open animation with bounce
				v147:TweenSize(UDim2.new(0, 555, 0, 352), "Out", "Back", 0.5, true);
				v3:Create(v147, TweenInfo.new(0.5, Enum.EasingStyle.Back, Enum.EasingDirection.Out), {
					BackgroundTransparency = 0.25
				}):Play();
			end
		end
	...
	v278.T = function(v638, v639, v640)
		...
		function ActivateTab(v910)
			if activeTab then
				-- Smooth fade out
				v3:Create(activeTab, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
					BackgroundTransparency = 1,
					Size = UDim2.new(1, 0, 1, 0)
				}):Play();
				local activeTabText = activeTab:FindFirstChildOfClass("TextLabel");
				if activeTabText then
					v3:Create(activeTabText, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
			...
			v3:Create(activeTab, TweenInfo.new(0.3, Enum.EasingStyle.Back, Enum.EasingDirection.Out), {
			...
			local activeTabText = activeTab:FindFirstChildOfClass("TextLabel");
			if activeTabText then
				v3:Create(activeTabText, TweenInfo.new(0.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
					TextTransparency = 0,
					TextSize = 15.5
				}):Play();
				wait(0.1);
		...
		v920.MouseEnter:Connect(function()
			v3:Create(v922, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
				BackgroundTransparency = 0.7,
				Size = UDim2.new(1, 4, 1, 4),
				Position = UDim2.new(0, -2, 0, -2)
			}):Play();
			v3:Create(v920, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
				TextSize = 16
			}):Play();
		end);
		...
		v920.MouseButton1Click:Connect(function()
			...
			v3:Create(v920, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
				TextSize = 18
			}):Play();
			wait(0.1);
			v3:Create(v920, TweenInfo.new(0.2, Enum.EasingStyle.Back, Enum.EasingDirection.Out), {
				TextSize = 15
			}):Play();
			v3:Create(v920, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
		...
		v962.MouseEnter:Connect(function()
			v3:Create(v962, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
				BackgroundTransparency = 0.6,
				Size = UDim2.new(1, 4, 1, 4),
				Position = UDim2.new(0, -2, 0, -2)
			}):Play();
		end);
		v962.MouseLeave:Connect(function()
			v3:Create(v962, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
				BackgroundTransparency = 0.8,
				Size = UDim2.new(1, 0, 1, 0),
				Position = UDim2.new(0, 0, 0, 0)
		...
		v965.MouseButton1Click:Connect(function()
			if (v958 == false) then
				...
				-- Smooth toggle animation with bounce
				v967:TweenPosition(UDim2.new(0, 27, 0, 2), "Out", "Elastic", 0.3, true);
				v3:Create(v965, TweenInfo.new(0.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
					BackgroundColor3 = Color3.fromRGB(0, 255, 100)
				}):Play();
				v3:Create(v967, TweenInfo.new(0.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
					BackgroundColor3 = _G.TrueColor,
					Size = UDim2.new(0, 18, 0, 18)
				}):Play();
				wait(0.15);
				v3:Create(v967, TweenInfo.new(0.15, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
					Size = UDim2.new(0, 16, 0, 16)
				}):Play();
			else
				v958 = false;
				v961.Color = _G.Color;
				-- Smooth toggle off animation
				v967:TweenPosition(UDim2.new(0, 2, 0, 2), "Out", "Elastic", 0.3, true);
				v3:Create(v965, TweenInfo.new(0.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
					BackgroundColor3 = Color3.fromRGB(46, 56, 56)
				}):Play();
				v3:Create(v967, TweenInfo.new(0.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
		...
		v701.Dropdown = function(v1017, v1018, v1019, v1020)
			...
			for v1578, v1579 in next, v1019 do
				...
				v1580.MouseEnter:Connect(function()
					v1580.BackgroundTransparency = 0.8;
					v3:Create(v1580, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
						TextTransparency = 0,
						TextSize = 13,
						BackgroundTransparency = 0.7,
			...
			v1031.MouseButton1Click:Connect(function()
				if (v1021 == false) then
					v1021 = true;
					-- Smooth dropdown expand with bounce
					v1022:TweenSize(UDim2.new(0, 379, 0, 142), "Out", "Back", 0.3, true);
					v3:Create(v1032, TweenInfo.new(0.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
						Rotation = 0
					}):Play();
					v3:Create(v1031, TweenInfo.new(0.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
						BackgroundTransparency = 0
					}):Play();
				else
					v1021 = false;
					-- Smooth dropdown collapse
					v1022:TweenSize(UDim2.new(0, 379, 0, 38), "Out", "Quad", 0.2, true);
					v3:Create(v1032, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
						Rotation = 180
					}):Play();
					v3:Create(v1031, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
...
v67:Seperator("Join Zalo");
v67:Label("Everyone Goes Into Socialize");
v67:Button("Copy Zalo Link", function()
	setclipboard("https://zalo.me/g/ysghpz101");
end);
v67:Seperator("Time");
